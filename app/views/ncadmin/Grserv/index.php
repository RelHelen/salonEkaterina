...
<section class="card">
    <div class="container">
        ...
        <!-- /filter -->
        <div class="card-header">
            <h3 class="card-title">Список групп услуг</h3>
        </div>
    </div>
    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr class="" data-id="<?= $item['ID_GR']; ?>">
                                            ...
                                            <td>
                                                <a href="<?= ADMIN; ?>/vidserv/view?id=<?= $item['ID_GR']; ?>"><i class="fa fa-fw fa-eye text-primary mr-2"></i></a>

                                                <a href="<?= ADMIN; ?>/vidserv/change?id=<?= $item['ID_GR']; ?>"><i class="fa fa-pencil text-success mr-2"></i></a>

                                                <a class="delete" href="<?= ADMIN; ?>/vidserv/delete?id=<?= $item['ID_GR']; ?>"><i class="fa fa-window-close text-danger"></i></a>
                                            </td>
                                        </tr>
