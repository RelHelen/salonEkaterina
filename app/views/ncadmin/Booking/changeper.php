...
<section class="card">
    <div class="card-header">
        <!-- <div class="float-right">
            <a href="<?= ADMIN; ?>/booking/change?id=<?= $contract['ID_O']; ?>&status=2" class="btn btn-grey btn-xs">Одобрить</a>
            <a href="<?= ADMIN; ?>/booking/change?id=<?= $contract['ID_O']; ?>&status=2" class="btn btn-grey btn-xs">Отмнить</a>
