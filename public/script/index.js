...
Cal.prototype.showMonth = function (y, m) {
  ...
  do {
    ...
    if (chkY == this.currYear && chkM == this.currMonth && i == this.currDay) {
      html +=
        '<td class="today" data-toggle="modal" data-target="#myModal"><a href="#">' +
        i +
        '</a></td>';
    } else {
      if (i < 20 || i == 23 || i == 26) {
        html +=
          '<td class="easy" data-toggle="modal" data-target="#myModal"><a href="#">' +
          i +
          '</a></td>';
      } else {
        html +=
          '<td class="normal" data-toggle="modal" data-target="#myModal"><a href="#">' +
          i +
          '</a></td>';
      }
    }
...
function modalTime() {
  ...
  var i = 10;
  do {
    html += '<td class="" data-toggle="modal"><a href="#">' + i + '</a></td>';
    i++;
  } while (i <= 21);
